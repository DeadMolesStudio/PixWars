...
var helpTextTitle = "Описание игры";
var helpText = "Мы рады приветствовать тебя в нашей увлекательной игре PixWars. Это потрясающая многопользовательская онлайн-игра, где ты можешь творить, всего лишь закрашивая пиксели. Все что тебе требуется - это раскрасить поле, как тебе захочется, просто нажимай на пиксель и выбирай один из 16 красочных цветов. Но все конечно же не так просто! У тебя есть много соперников, которые хотят раскрасить тот же пиксель, что и ты. Не дай им это сделать, отвоюй свой кусочек поля!!! Иначе придется ждать пока пиксель разблокируется, ведь после того, как пиксель закрашивают, он блокируется на целую минуту! Хорошо провести время в нашей игре, надеемся, у тебя получится нарисовать свою красивую картинку!";
